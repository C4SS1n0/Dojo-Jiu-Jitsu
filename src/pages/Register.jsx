...
const Register = ({ selectedRole, onVolverRol, onVolverLogin }) => {
  ...
  const roleIcon = selectedRole === "maestro" ? (
      ...
      <div className="register-wrapper">
        ...
        <form className="register-form" onSubmit={handleSubmit}>
          ...
          {selectedRole === "maestro" && (
            <>
              <div className="form-group">
                <label className="form-label">¿Estás afiliado a una academia?</label>
                ...
                {errors.afiliado && <span className="error-text">{errors.afiliado}</span>}
              </div>
              ...
              {formData.afiliado === "si" && (
                <div className="form-group">
                  ...
                  {errors.academia && <span className="error-text">{errors.academia}</span>}
                </div>
              )}

              <div className="form-group">
                <label className="form-label">Adjuntar título (PDF o imagen)</label>
                <div className="file-upload-wrapper">
                  ...
                  <label htmlFor="titulo-upload" className="file-upload-label">
                    ...
                    <span>{formData.titulo ? formData.titulo.name : "Seleccionar archivo"}</span>
                  </label>
                </div>
          ...
          <div className="form-footer">
            ...
            <button type="button" onClick={onVolverLogin} className="login-link">
